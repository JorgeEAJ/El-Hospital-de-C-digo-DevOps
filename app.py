...
# 2. Error de formato: Espaciado caótico e indentación desastrosa (Black lo arreglará)
    nombre =  input("Ingrese nombre del paciente: ")
    mensaje= ""

# 3. Error de lógica: Comparación poco clara (Flake8 sugerirá mejores prácticas)
    if gravedad == 'critico':
# 4. Error de formato: Mezcla de comillas simples y dobles, y falta de espacios
